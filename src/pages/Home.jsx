  ...
  return (
    <div className="relative">
      ...
      <nav
        ...
        onFocus={handleDotsEnter}
        onBlur={handleDotsLeave}
      >
      ...
      <section id="home" className="relative min-h-screen flex items-center px-8 md:px-16 max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row items-center gap-12 w-full">
          ...
          <div className="flex-1 flex flex-col items-start text-left">
            ...
            >
             I turn ideas into practical software solutions with clean code, testing, and continuous improvement, 
             focused on building reliable and user-friendly applications through my studies.
            </motion.p>

            <div className="flex gap-2 flex-wrap mb-8">
              {[
                { label: 'Learning Skills',  color: 'bg-blue-100   dark:bg-blue-900/50   text-blue-800   dark:text-blue-200'   },
                { label: 'Solving Problems', color: 'bg-purple-100 dark:bg-purple-900/50 text-purple-800 dark:text-purple-200' },
                { label: 'Creating Solutions',    color: 'bg-teal-100   dark:bg-teal-900/50   text-teal-800   dark:text-teal-200'   },
              ].map((tag, i) => (
                <motion.span
                  key={tag.label}
     ...
     <section
  id="about"
  className="relative flex items-center bg-gray-50/80 dark:bg-slate-900/80 backdrop-blur-sm"
>
  <AboutAchievements />
</section>
